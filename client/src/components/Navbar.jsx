  ...
  return (
    <nav className="bg-white border-b border-gray-200 shadow-sm sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
        <Link to="/home/feed" className="text-2xl font-bold text-gray-900">
          DevMatch
        </Link>
            ...
            {dropdownOpen && (
              <div className="absolute right-0 mt-2 w-56 bg-white border border-gray-200 rounded-lg shadow-md z-50">
                ...
                <Link
                  ...
                  className="flex items-center px-4 py-3 text-gray-700 hover:bg-gray-50 transition-colors"
                >
                  <UserPlus size={18} className="mr-2 text-green-500" />
                  Requests
                </Link>
                <Link
                  to="/home/membership"
                  className="flex items-center px-4 py-3 text-gray-700 hover:bg-gray-50 transition-colors"
                >
                  <BadgeCheck size={18} className="mr-2 text-green-600" />
                  Membership
                </Link>
                <hr className="my-1 border-gray-200" />
                <button
                  onClick={handleLogout}
                  className="w-full text-left flex items-center px-4 py-3 text-red-500 hover:bg-gray-50 hover:text-red-600 transition-colors"
                >
      ...
      {isOpen && (
        <div className="md:hidden px-4 pb-4 space-y-2 border-t border-gray-100 bg-white shadow-sm">
          ...
          <button
            onClick={handleLogout}
            className="flex items-center gap-2 py-2 text-red-500 hover:text-red-600"
          >
            <LogOut size={18} />
            Logout
          </button>
